...
import { Clock, Star, List, ExternalLink, User, LogOut } from 'lucide-react'
...
function PopupContent() {
  ...
  }, [filteredPrompts, activeTab, user])
          ...
          <div className="flex items-center space-x-2">
            {user ? (
              <div className="flex items-center space-x-2">
                ...
                <button
                  onClick={signOut}
                  className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-slate-600 hover:text-red-600 hover:bg-slate-50 rounded-md transition-colors"
                >
